...
const u8* wifista_ssid="2014IOT 1";			//路由器SSID号
const u8* wifista_encryption="wpawpa2_aes";	//wpa/wpa2 aes加密方式
const u8* wifista_password="iot123456"; 	//连接密码
...
{ 
	LCD_Clear(WHITE);
	POINT_COLOR=RED;
	Show_Str_Mid(0,y,"Wifi模块测试中",16,240); 
 	Show_Str_Mid(0,y+30,"按任意键继续",16,240); 				    	 
...
//	u16 rlen=0;
	...
	u8 timex;
	POINT_COLOR=RED;
	Show_Str_Mid(0,30,"Wifi模块测试中",16,240); 
